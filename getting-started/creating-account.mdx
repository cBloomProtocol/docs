...
Wallet installed? → Extension enabled? → Popups allowed?
        ↓                   ↓                 ↓
    Required           Must be on         Can block
        ↓                   ↓                 ↓
Wallet unlocked? → Network correct? → Browser current?
        ↓                   ↓                 ↓
   Password ok         Solana only      Latest version
```
...
App installed? → Latest version? → Deep links work?
       ↓               ↓                ↓
   App store       Auto-update      System setting
       ↓               ↓                ↓
Permissions? → Background on? → Storage space?
       ↓               ↓                ↓
   Grant all      Battery ok       Clear cache
```
