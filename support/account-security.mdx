...
```
Backup Strategy:
Write seed phrase → Store in 2+ places → Separate locations
        ↓                  ↓                    ↓
    On paper         Physical only         Not together
        ↓                  ↓                    ↓
Metal backup? → Tell someone where → Test recovery
        ↓                  ↓                    ↓
 Fire/water safe    Never the words      Practice run
```
