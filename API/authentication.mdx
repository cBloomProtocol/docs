...
<Steps>
  <Step title="Login to Bloom Protocol">
    Go to [bloomprotocol.ai](https://preflight.bloomprotocol.ai/builder) and connect your wallet
  </Step>
  <Step title="Navigate to API Keys">
    Go to [Builder > API Keys](https://preflight.bloomprotocol.ai/builder/api-keys)
  </Step>
...
1. Go to [API Keys page](https://preflight.bloomprotocol.ai/builder/api-keys)
